...
sns.countplot(data = df, x = 'DAY WEEK', order = sorted_days, color=custom_color)
...
def plot_grouped_boxplots(df, cat_col, num_col):
    ...
    for i in range(0, num_cats, group_size):
        ...
        sns.boxplot(x=cat_col, y=num_col, data=subset_df, color=custom_color)
...
fig = px.bar(
    ...
    color_discrete_sequence=['#b69595']  
)

fig.update_layout(yaxis=dict(autorange='reversed'))
fig.show()
fig.write_image("hipotesis_6.png")
